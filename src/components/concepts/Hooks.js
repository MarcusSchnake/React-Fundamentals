    ...
    return (
        <div className="main">
            <div className="mainDiv">
                ...
                <input value={queryNum} onChange={e => setQueryNum(e.target.value)} placeholder="enter your number" />
...
export default Hooks2;//this is the second hook2 component that we wrote to show difference between methods of writing a hook