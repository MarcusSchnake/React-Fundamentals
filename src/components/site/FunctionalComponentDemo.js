            ...
            <Row>
                <Col xs='12'>
                    ...
                    <dl>
                        ...
                        <dd>With the 'useEffect' hook, functional components can perform side effects with any props or state change.</dd>
                        <dt>return()</dt>
...
const HelloWorldFatArrow = () => (// added parethases NOT IN MODULE
    <div>
        <Card>
            <img width='100%' height='280px' src='https://i.ytimg.com/vi/-pfXEv9cFGE/maxresdefault.jpg' alt='card cap' />
            <CardBody>
